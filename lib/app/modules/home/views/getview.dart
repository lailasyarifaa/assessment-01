    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            _buildGreetingSection(), // Greeting section tetap di bagian atas
            _buildSearchBar(), // Search bar dipindahkan ke bawah greeting section
  ...
  Widget _buildGreetingSection() {
    return Padding(
      ...
      child: Column(
        ...
        children: const [
          Text(
            'Hello word', // Sesuai dengan gambar yang diberikan
            style: TextStyle(
              fontSize: 30,
              fontWeight: FontWeight.bold,
              color: Colors.black87,
          ...
          SizedBox(height: 12), // Spacing untuk menambah jarak sebelum search bar
        ],
      ),
    );
  }
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  overflow: TextOverflow.ellipsis, // Prevent overflow by ellipsis
                ),
                Text(
                  artist,
